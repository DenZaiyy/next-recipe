  ...
  return (
    <div className={"flex flex-col gap-8 md:pt-4 md:px-12"}>
        ...
        <div className="flex flex-col p-4 w-full md:w-1/2 items-center justify-center gap-4">
          ...
          <div className="flex gap-2">
            ...
            >
              <Heart
                fill={
                  favorites.some((recp) => recp.id === recipe?.id)
                    ? "red"
                    : "none"
                }
              ...
              >
                {recipe?.ingredients.map((ingredient) => (
                  <div key={ingredient.id}>
                    ...
                    <p
                      className={"text-sm md:text-md text-gray-400 text-center"}
                    >
      ...
      <div className={"w-full my-4 recipe-detail-slider"}>
        <h2>
          <Waypoints /> Steps{recipe?.steps && ` (${recipe?.steps.length})`}
        </h2>
        <Swiper {...swiperParams}>
          {recipe?.steps &&
          ...
          {recipe?.comments.length > 0 && (
            <div>
              <h2>
                ...
                {recipe?.comments && `(${recipe?.comments.length})`}
              </h2>
